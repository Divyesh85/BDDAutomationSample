...
public class ReportSolution {
	...
	public void backupReport() {
		...
		FtpUploadUtil.upload(Environment.getTeamName(), targetFTPFolder, CucumberReport.getReportFolderPath());
	}
	...
	/**
	 * Author: pli3
	 * Created Date: 2015年12月23日 下午4:32:24
	...
	public String getContent() {
		...
		String cucumberReportPath="ftp://" + BaseCons.FTP_HOST + File.separator + bean.getTeam() + File.separator
			+ targetFTPFolderName + File.separator+CucumberReport.getReportFolder() + File.separator + CucumberReport.getReportName();
...
//		logger.info(result);
	...
	/**
	 * Author: pli3
	 * Created Date: 2015年12月28日 下午9:00:32
